...
let NotificationType = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)("notification_types")];
    ...
    var NotificationType = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "NotificationType");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)("uuid")];
        _title_decorators = [(0, typeorm_1.Column)({ type: "varchar", length: 50 })];
        ...
        NotificationType = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return NotificationType = _classThis;
})();
